/* -------------------------------------------------
	EMERHUB - Registration Company
	Created By: Rangga Herly Hilman Herawan
	EMERHUB Front End Developer Recruitment Assignment
-------------------------------------------------- */
...
-------------------------------------------------- */
	function initKenburns () {
		...
		if (hasKenburns) {
			...
			$('.kenburns').kenburns({
				images: ['assets/images/hero/jakarta-busway-emerhub.jpg',
						'assets/images/hero/freestocks-org-229658-unsplash.jpg',
						'assets/images/hero/rawpixel-com-550994-unsplash.jpg'
						],
